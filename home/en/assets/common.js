(function() {
    ...
    var detailLinks = isEnglish ? [
        { href: 'subscription/pricing.html', text: 'Pricing' },
        { href: 'subscription/terms-of-service.html', text: 'Terms of Service' },
        { href: 'subscription/refund-policy.html', text: 'Refund Policy' }
    ] : [
        { href: 'subscription/pricing.html', text: '요금제' },
        { href: 'subscription/terms-of-service.html', text: '이용약관' },
        { href: 'subscription/refund-policy.html', text: '환불 정책' }
    ];
